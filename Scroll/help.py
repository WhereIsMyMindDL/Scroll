...
from settings import RETRY_COUNT, delay_wallets, delay_transactions, waiting_gas, bot_id, bot_token
...
def send_message(send_list):
    try:
        ...
        bot.send_message(bot_id, str_send, parse_mode='Markdown', disable_web_page_preview=True)
